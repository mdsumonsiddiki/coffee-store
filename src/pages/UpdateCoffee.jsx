...
const UpdateCoffee = () => {
    return (
        ...
        <div className="text-center px-56 pb-14">
            <h2 className="text-[#374151] font-rancho text-5xl mb-5">Update Existing Coffee Details</h2>
        ...
        <form className="grid grid-cols-2 gap-12">
            ...
            <button className="w-full col-span-2 font-rancho rounded-md text-[#331A15] text-2xl bg-[#E3B577] border-2 border-[#331A15] px-5 py-2">Update Coffee Details</button>
        </form>
    </div>
    );
};
