...
const AddCoffee = () => {
    return (
        <div className="container mx-auto my-16">
            <Link to='/' className="text-[#374151] font-rancho text-3xl">Back to home</Link>
            <div className="bg-[#F4F3F0] py-20 px-28 mt-14">
                <div className="text-center px-72 mb-14">
                    <h2 className="text-[#374151] font-rancho text-5xl mb-5">Add New Coffee</h2>
                    <p className="text-lg text-[#1B1A1A]">It is a long established fact that a reader will be distraceted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using Content here.</p>
                </div>
                <form className="grid grid-cols-2 gap-12">
                    ...
                    <button className="w-full col-span-2 font-rancho rounded-md text-white text-2xl bg-[#E3B577] border-2 border-[#331A15] px-5 py-2">Add Coffee</button>
                </form>
            </div>
        </div>
    );
